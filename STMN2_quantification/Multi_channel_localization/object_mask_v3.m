...
function [objectarray, objectmask, objectnumber, binarymask, estimatedmissedcells, meansize, multiobjectcenters] = object_mask_v3(channel_matrix,minimumradius,sensitivity)

dimensions = size(channel_matrix);
binarymask = bradley(channel_matrix,[500 500],sensitivity);% calculates mask using Bradley method, sensitivity values of 0-100
