...
function TIF = Stitcher_nonoverlap(files,rownumber,columnnumber,wavelengthnumber,stitchwavelength,coloroption)
...
parfor n = 1:numel(orderedfiles) %THIS CAN BE MADE INTO A PARFOR LOOP IF RAM IS LARGE ENOUGH
    ...
    for nn = 1:rownumber
        ...
        for nnn = 1:columnnumber-1
            ...
            [baseimage,otherimagesout] = horizontalaligner_nonoverlap(baseimage,imagetoadd,tempindex,imagetoaddindex,stitchwavelength,otherimagesout,otherwavelengthsindex);
        end
    ...
    for nn = 1:rownumber-1
        ...
        [baseimage,otherimagesout] = verticalaligner_nonoverlap(baseimage,imagetoadd,horizontalmergecell,nn,otherimagesout);
    end
